...
{
  private static transient Log log = LogFactory.getLog(SSHUtil.class);
  
  public static String ssh4Shell(String ip, int sshPort, String username, String password, String shellName, String shell)
    throws Exception
  {
  ...
  public static String ssh4Command(String ip, int sshPort, String username, String password, String command)
    throws Exception
  {
    String rtn = null;
    Connection conn = null;
