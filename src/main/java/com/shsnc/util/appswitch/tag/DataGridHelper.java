...
public class DataGridHelper
{
  ...
  public static void setDataGrid2Session(HttpServletRequest request, String uuid, DataGrid dataGrid)
    throws Exception
  {
  ...
  public static DataGrid getDataGrid4Session(HttpServletRequest request, String uuid)
    throws Exception
  {
    DataGrid rtn = null;
    Object obj = request.getSession().getAttribute("DATA_GRID_SESSION_ID");
