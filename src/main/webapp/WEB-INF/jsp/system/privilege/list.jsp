            ...
            <div class="portlet light">
                ...
                <div class="portlet-body flip-scroll">
                    <table class="table table-bordered table-striped table-condensed flip-content">
                        ...
                        <c:forEach items="${privilegeList.datas}" var="privilege" varStatus="i">
                            <tr>
                                <td>${i.index+1}</td>
                                ...
                                <td>
                                    <a class="btn btn-icon-only btn-circle red"
                                       href="${pageContext.request.contextPath}/privilege/edit?id=${privilege.id}"
                                       data-toggle="tooltip" data-placement="top" title="编辑" target="mainFrame"><i class="fa fa-edit"></i>
                                    </a>
                                    <a class="btn btn-icon-only btn-circle purple"
                                       href="${pageContext.request.contextPath}/privilege/del?id=${privilege.id} "
                                       data-toggle="tooltip" data-placement="top" title="删除"
                                       onclick="return window.confirm('您确定要删除吗？')" target="mainFrame"><i class="fa fa-times"></i>
                                    </a>
                    ...
                    <div>
                        <c:if test="${privilegeList.total > 0}">
                            <jsp:include page="../../common/Page.jsp">
                                <jsp:param value="${privilegeList.total }" name="totalRecord"/>
