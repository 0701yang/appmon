    ...
    this.eventCatcher = function (obj) {
        ...
        var func_server = function (catcher, rpc) {
            ...
            var z = function () {
                ...
                var request = postVar;
                if (postVar2) {
                    for (var i = 0; i < arguments.length; i++)request += "<param><value><string>" + (arguments[i] ? arguments[i].toString() : "") + "</string></value></param>";
                    request += postVar2
                } else
                    for (var i = 0; i < arguments.length; i++)request += ( '&arg' + i + '=' + escape(arguments[i]));
